...
version = bxa.__version__
# The full version, including alpha/beta/rc tags.
release = bxa.__version__
...
edit_on_github_project = 'JohannesBuchner/BXA'
...
#
html_theme_options = {
    'canonical_url': 'https://johannesbuchner.github.io/BXA/',
...
latex_documents = [
  ('index', 'bxa.tex', project + ' Documentation',
   author, 'howto'),
]
...
man_pages = [
    ('index', 'bxa', project + ' Documentation',
     [author], 1)
]
